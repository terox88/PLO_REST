...
public class GameMapper {
    ...
    public GameDto mapToGameDto(Game game) {
        return new GameDto(game.getId(), boardMapper.mapToBoardDto(game.getBoard()), mapToLandTokenDtoList(game.getLandTokens()), boardMapper.mapToPlayerDto(game.getActivePlayer()), game.isEnded(), game.isPrepDone(), boardMapper.mapToPlayerDto(game.getWinner()), game.getCurrentPlayersOrder() == null ? new ArrayList<>() : game.getCurrentPlayersOrder());
    }
